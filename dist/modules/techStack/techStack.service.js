...
class TechStackService {
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return database_1.db.techStack.create({ data });
        });
    }
    findAll(_a) {
        return __awaiter(this, arguments, void 0, function* ({ userId, page = 1, limit = 10, sortBy = 'name', sortDir = 'asc', search, }) {
            ...
            const total = yield database_1.db.techStack.count({
                where,
            });
            // Query data
            const TechStacks = yield database_1.db.techStack.findMany({
                where,
                orderBy: {
                    [sortBy]: sortDir,
                },
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return database_1.db.techStack.findUnique({ where: { id } });
        });
    }
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return database_1.db.techStack.update({
                where: { id: data.id },
                data,
            });
        });
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return database_1.db.techStack.delete({ where: { id } });
        });
    }
}
