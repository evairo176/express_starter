...
const blog_category_schema_1 = require("../../common/zod/blog-category.schema");
...
class BlogCategoryController {
    constructor(blogCategoryService) {
        this.create = (0, middlewares_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const parsed = blog_category_schema_1.CreateBlogCategorySchema.parse(req.body);
            const result = yield this.blogCategoryService.create(parsed);
        ...
        this.findAll = (0, middlewares_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const { data, metadata } = yield this.blogCategoryService.findAll(Object.assign({}, req === null || req === void 0 ? void 0 : req.query));
            return response_1.default.success(res, data, `Find all blog category successfully`, http_config_1.HTTPSTATUS.OK, metadata);
        }));
        this.getOne = (0, middlewares_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const result = yield this.blogCategoryService.findById(req.params.id);
            if (!result) {
        ...
        this.update = (0, middlewares_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
            const parsed = blog_category_schema_1.UpdateBlogCategorySchema.parse(Object.assign(Object.assign({}, req.body), { id: req.params.id }));
            const result = yield this.blogCategoryService.update(parsed);
        ...
        this.destroy = (0, middlewares_1.asyncHandler)((req, res) => __awaiter(this, void 0, void 0, function* () {
            yield this.blogCategoryService.delete(req.params.id);
