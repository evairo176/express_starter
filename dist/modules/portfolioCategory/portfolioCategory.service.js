...
exports.PortfolioCategoryService = void 0;
const database_1 = require("../../database/database");
class PortfolioCategoryService {
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return database_1.db.portfolioCategory.create({ data });
        });
    }
    findAll(_a) {
        return __awaiter(this, arguments, void 0, function* ({ userId, page = 1, limit = 10, sortBy = 'updatedAt', sortDir = 'desc', search, }) {
            ...
            const total = yield database_1.db.portfolioCategory.count({
                where,
            });
            // Query data
            const portfolioCategorys = yield database_1.db.portfolioCategory.findMany({
                where,
                orderBy: {
                    [sortBy]: sortDir,
                },
    ...
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return database_1.db.portfolioCategory.update({
                where: { id: data.id },
                data,
            });
        });
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return database_1.db.portfolioCategory.delete({ where: { id } });
        });
    }
}
