...
exports.passwordResetTemplate = exports.verifyEmailTemplate = void 0;
const verifyEmailTemplate = (url, brandColor = '#2563EB') => ({
...
const passwordResetTemplate = (url, brandColor = '#2563EB') => ({
