...
import { blogCommentController } from './blogComment.module';
 ...
 */
blogCommentRoutes.get(
  '/public/:slug/comments',
  blogCommentController.listApproved,
);
...
export default blogCommentRoutes;
