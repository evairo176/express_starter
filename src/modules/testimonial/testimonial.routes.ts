...
import { testimonialController } from './testimonial.module';
 ...
 */
testimonialRoutes.post('/', authenticateJWT, testimonialController.create);
 ...
 */
testimonialRoutes.get('/public', testimonialController.findPublished);
